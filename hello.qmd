...
# m1 <- polr(factor(strength) ~ . - password - true_val - true_val_strength - offline_crack_sec - rank - num_letters, data = pass_more)
# summary(m1)

# the above isn't running... 

m2 <- polr(factor(true_val_strength) ~ . - password - num_letters - offline_crack_sec - strength - rank - true_val, data = pass_more)
summary(m2)
...
strong_mod <- glm(strong ~ . - password - num_letters - offline_crack_sec - strength - rank - true_val - true_val_strength,
...
true_strong_mod <- glm(true_strong ~ . - password - num_letters - offline_crack_sec - strength - rank - true_val - true_val_strength,
