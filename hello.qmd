...
Our research question is: What characteristics yield strong passwords? We measure password strength in two ways: "strength," which is calculated XX, and the time the password takes to crack by online guessing. We decide which passwords are the strongest overall by looking at the characteristics that appear to impact both measures of password strength. 

*do we want to look at true_val or offline crack sec* 
*what does "strength" mean, i.e. how is it calculated?* 
